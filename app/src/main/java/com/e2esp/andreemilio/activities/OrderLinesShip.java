...
public class OrderLinesShip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = getContentResolver().query(AndreEmilioContract.OrdersEntry.CONTENT_URI,
                ORDER_PROJECTION,
                query,
                parametersOrder,
                null);
        ...
        query = AndreEmilioContract.ProductEntry.COLUMN_ID + " IN (" + TextUtils.join(", ", parameters) + ")";
        cursor = getContentResolver().query(AndreEmilioContract.ProductEntry.CONTENT_URI,
                PRODUCT_PROJECTION,
                query,
