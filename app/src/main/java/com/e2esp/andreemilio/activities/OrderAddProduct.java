...
public class OrderAddProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String query = AndreEmilioContract.ProductEntry.COLUMN_ID + " == ?" ;
    ...
    private void updateProduct() {
        ...
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_ID, mProductSelected.getId());
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_TITLE, mProductSelected.getTitle());
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_SKU, mProductSelected.getSku());
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_PRICE, mProductSelected.getPrice());
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_STOCK, mProductSelected.getStockQuantity());
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_CATEGORIES, mProductSelected.getCategoryNames());
        productValues.put(AndreEmilioContract.ProductEntry.COLUMN_JSON, mGson.toJson(mProductSelected));
        ...
        for(Variation variation:mProductSelected.getVariations()) {
            ...
            variationValues.put(AndreEmilioContract.ProductEntry.COLUMN_TITLE, mProductSelected.getTitle());
            variationValues.put(AndreEmilioContract.ProductEntry.COLUMN_SKU, mProductSelected.getSku());
            variationValues.put(AndreEmilioContract.ProductEntry.COLUMN_PRICE, mProductSelected.getPrice());
            variationValues.put(AndreEmilioContract.ProductEntry.COLUMN_STOCK, mProductSelected.getStockQuantity());
            variationValues.put(AndreEmilioContract.ProductEntry.COLUMN_CATEGORIES, mProductSelected.getCategoryNames());
            variationValues.put(AndreEmilioContract.ProductEntry.COLUMN_JSON, mGson.toJson(mProductSelected));
