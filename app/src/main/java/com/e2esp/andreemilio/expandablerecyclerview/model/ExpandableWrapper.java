package com.e2esp.andreemilio.expandablerecyclerview.model;
 ...
 */
public class ExpandableWrapper<P extends com.e2esp.andreemilio.expandablerecyclerview.model.Parent<C>, C> {
