package com.e2esp.andreemilio.expandablerecyclerview;
...
import com.e2esp.andreemilio.expandablerecyclerview.model.Parent;
 ...
 * @since 5/27/2015
 */
public abstract class ParentViewHolder<P extends Parent<C>, C> extends RecyclerView.ViewHolder implements View.OnClickListener {
    @Nullable
    ...
    public int getParentAdapterPosition() {
        int flatPosition = getPositionFromAdapter();
    ...
    protected void expandView() {
        ...
        if (mParentViewHolderExpandCollapseListener != null) {
            mParentViewHolderExpandCollapseListener.onParentExpanded(getPositionFromAdapter());
        }
    }

    public abstract int getPositionFromAdapter();
    ...
    protected void collapseView() {
        ...
        if (mParentViewHolderExpandCollapseListener != null) {
            mParentViewHolderExpandCollapseListener.onParentCollapsed(getPositionFromAdapter());
        }
    }
}
