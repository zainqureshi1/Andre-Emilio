...
public class DrawerItem implements Parent<com.e2esp.andreemilio.models.orders.DrawerSubItem> {

    private String section;
    private int icon;
    private int count = 0;
    private ArrayList<com.e2esp.andreemilio.models.orders.DrawerSubItem> subItems;
